...
public class GRNExternalLauncher extends Application {

    private static final String LAUNCHER_FXML = "/com/saiton/ihm/stock/GRNExternal.fxml";
    private static final String TITLE = "GRN External" ;
    @Override
